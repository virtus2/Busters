...
void ABustersCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ABustersCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * TurnRateGamepad * GetWorld()->GetDeltaSeconds());
}

void ABustersCharacter::MoveForward(float Value)
{
...
void ABustersCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
